    ...
    <div className="container mx-auto px-4 py-16 md:py-24 max-w-4xl">
      ...
      <div className="prose prose-invert prose-lg mx-auto text-neutral-300 prose-h2:text-primary prose-h2:font-bold prose-a:text-primary hover:prose-a:text-accent">
        <p>
          ...
          <Link href="/">https://autospark.co.ke</Link>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by AutoSpark and how we use it.
        </p>
        <p>
