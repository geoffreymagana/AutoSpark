...
export const products: Product[] = [
  ...
  { id: 5, name: 'Iridium Spark Plugs (Set of 4)', price: 2500, category: 'Engine', make: 'Ford', model: 'Mustang', status: 'new', discount: 0, image: '/images/products/spark-plugs.png', aiHint: 'spark plug', description: "Ignite your engine's potential. These iridium spark plugs offer a longer lifespan, improved fuel efficiency, and a more consistent spark for smoother idling and better acceleration.", specs: [{name: 'Material', value: 'Iridium'}, {name: 'Quantity', value: '4'}], relatedProducts: [1, 4] },
  { id: 6, name: 'Drilled & Slotted Rotors', price: 39999, category: 'Brakes', make: 'Chevrolet', model: 'Corvette', status: 'none', discount: 0, image: '/images/products/brake-disc.png', aiHint: 'brake disc', description: "Cooler brakes mean better performance. These drilled and slotted rotors dissipate heat more effectively, reducing brake fade during aggressive driving and providing a firm pedal feel.", specs: [{name: 'Type', value: 'Drilled & Slotted'}, {name: 'Position', value: 'Front Pair'}], relatedProducts: [2] },
  { id: 7, name: 'Performance Coilover Kit', price: 125000, category: 'Suspension', make: 'Honda', model: 'Civic Type R', status: 'popular', discount: 10, image: '/images/products/suspension.png', aiHint: 'car suspension', description: "Take control of your car's handling. This fully adjustable coilover kit allows you to dial in the perfect ride height and damping for the street or the track.", specs: [{name: 'Adjustability', value: '32-way Damping'}, {name: 'Spring Rate', value: '8k/6k'}], relatedProducts: [3, 10] },
  { id: 8, name: 'LED Headlight Conversion Kit', price: 14999, category: 'Lighting', make: 'All', model: 'All', status: 'none', discount: 0, image: '/images/products/headlight.png', aiHint: 'car headlight', description: "See and be seen. This plug-and-play LED headlight kit provides a brilliant, white light that dramatically improves nighttime visibility and gives your car a modern look.", specs: [{name: 'Color Temp', value: '6000K'}, {name: 'Lumens', value: '12,000'}], relatedProducts: [11] },
  { id: 9, name: 'Turbocharger Upgrade Kit', price: 250000, category: 'Engine', make: 'Subaru', model: 'WRX STI', status: 'outOfStock', discount: 0, image: '/images/products/turbo.png', aiHint: 'turbocharger', description: "Ready for serious power? This complete turbocharger upgrade kit includes everything you need to significantly boost your engine's horsepower and torque. Professional installation recommended.", specs: [{name: 'Compressor', value: 'Garrett GT3076R'}, {name: 'Includes', value: 'All gaskets & lines'}], relatedProducts: [1, 12] },
  { id: 10, name: 'Racing Seat', price: 59900, category: 'Interior', make: 'All', model: 'All', status: 'none', discount: 20, image: '/images/products/racing-seat.png', aiHint: 'racing seat', description: "Stay planted in the corners. This lightweight racing seat offers exceptional support and safety for track days, while still being comfortable enough for daily driving.", specs: [{name: 'Material', value: 'Fiberglass'}, {name: 'Harness', value: '5-point compatible'}], relatedProducts: [7] },
  { id: 11, name: 'Carbon Fiber Hood', price: 89999, category: 'Body', make: 'Nissan', model: 'GT-R', status: 'new', discount: 0, image: '/images/products/car-hood.png', aiHint: 'car hood', description: "Reduce weight and add aggressive styling with this high-quality carbon fiber hood. Features a UV-resistant clear coat for a long-lasting, glossy finish.", specs: [{name: 'Material', value: 'Carbon Fiber'}, {name: 'Weave', value: '2x2 Twill'}], relatedProducts: [8, 12] },
  { id: 12, name: 'Cat-Back Exhaust System', price: 150000, category: 'Exhaust', make: 'Porsche', model: '911', status: 'popular', discount: 0, image: '/images/products/exhaust.png', aiHint: 'exhaust pipe', description: "Unleash your engine's true sound. This stainless steel cat-back exhaust system provides a deep, aggressive tone, improved exhaust flow, and a noticeable horsepower gain.", specs: [{name: 'Material', value: 'T304 Stainless Steel'}, {name: 'Tip Diameter', value: '4 inches'}], relatedProducts: [9] },
];
